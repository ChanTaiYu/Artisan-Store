        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">Online Artisan Shop</a>
            ...
            <div class="container-fluid dashboard-content">    
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner rounded">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="uploads/artisan.jpeg" alt="First slide" height="700px" width="">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <h3 class="text-white">Keycap</h3>
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/artisan2.jpeg" alt="Second slide" height="700px">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/artisan3.jpeg" alt="Third slide" height="700px">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <h3 class="text-white">Lorem ipsum dolor sit.</h3>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit.</p>
                                        <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a>
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/artisan4.jpeg" alt="Fourth slide" height="700px">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <h3 class="text-white">Lorem ipsum dolor sit.</h3>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Dolor sit amet consectetur adipiscing elit quisque faucibus.</p>
                                        <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a>
                                ...
                                <!-- <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/6.jpg" alt="Fifth slide" height="700px">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/7.jpg" alt="Sixth slide" height="700px">
                                    <div class="carousel-caption d-md-block pb-5">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Our very first priority is the quality we never compromised in the quality of our artisan products.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                <h1 class="card-title"><i class="fas fa-cube"></i></h1>
                                <h3 class="card-title">All natural</h3>
                                <p class="card-text">Our every product is made with natural stuff. Hearts and soul poured into every product.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">We provide free delivery to our customers. Terms and conditions apply.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row m-5 hero-image2 rounded">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3 hero-text">
                        ...
                        <p class="text-dark px-5">Welcome to Online Artisan Shop, where creativity and craftsmanship come together.</p>
                        <p class="text-dark px-5">We specialize in handcrafted goods made with passion and precision, offering unique pieces that celebrate artistry. From elegant accessories to timeless home decor, every item is designed to inspire. Experience exceptional quality and dedicated service with us—your go-to destination for artisanal treasures.</p>
