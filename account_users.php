...
<head>
    ...
    <title>Artisan - Account Users</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            $select = "SELECT * FROM shop_orders where users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            // $select = "SELECT * FROM shop_orders_detail";
                                            $select = "SELECT shop_orders_detail.*, shop_orders.orders_id FROM shop_orders_detail JOIN shop_orders ON shop_orders_detail.orders_id = shop_orders.orders_id WHERE users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
