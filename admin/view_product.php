...
<head>
    ...
    <title>Artisan - View Product</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT shop_product.*, shop_category.category_name FROM shop_product JOIN shop_category ON shop_product.product_category = shop_category.category_id";
