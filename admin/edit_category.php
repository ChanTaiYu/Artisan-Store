...
if ($file_name != "") {
    ...
    $update = "UPDATE shop_category SET category_name = '$category_name', category_image = '$new_file_name' where category_id = $hidden_id";
    mysqli_query($conn, $update);
    header('Location: view_category.php?edit_msg=1');
}
elseif ($file_name == "") {
	$update = "UPDATE shop_category SET category_name = '$category_name' where category_id = $hidden_id";
    mysqli_query($conn, $update);
    header('Location: view_category.php?edit_msg=1');
}
?>